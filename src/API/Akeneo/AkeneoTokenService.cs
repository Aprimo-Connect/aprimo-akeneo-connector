...
{
	public class AkeneoTokenService : IAkeneoTokenService
	{
		...
		public AkeneoTokenService(ILogger<AkeneoService> logger, HttpClient httpClient, AkeneoTenant tenant, ITokenStorage tokenStorage)
		{
			_logger = logger;
		...
		{
			return _tokenStorage.GetTokenAsync(_tokenStorageKey);
		}
	}
}
